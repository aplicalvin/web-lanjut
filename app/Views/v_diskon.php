                        ...
                        <form action="<?= base_url('diskon/edit/' . $diskon['id']) ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="tanggal" class="form-control" id="tanggal" value="<?= $diskon['tanggal'] ?>" placeholder="tanggal diskon" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="name">nominal</label>
                                    <input type="text" name="nominal" class="form-control" id="nominal" value="<?= $diskon['nominal'] ?>" placeholder="nominal diskon" required>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('diskon') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name">nominal</label>
                        <input type="text" name="nominal" class="form-control" id="nominal" placeholder="nominal diskon" required>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
